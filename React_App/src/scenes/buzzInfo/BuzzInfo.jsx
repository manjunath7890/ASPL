...
const BUZZ_MODELS = [
  {
    ...
    imageAlt: "Buzz electric 3 wheeler cargo vehicle - Container",
  ...
  },
  {
    ...
    imageAlt: "Buzz electric 3 wheeler cargo vehicle - Low Body",
  ...
  },
  {
    ...
    imageAlt: "Buzz electric 3 wheeler cargo vehicle - Flat Bed",
    desc: "Maximum flexibility with an open flat bed for oversized cargo.",
  },
];

const SPECS = [
  { label: "Range", value: "140 km", icon: ElectricBoltIcon },
  { label: "Payload Capacity", value: "600 kg", icon: LocalShippingIcon },
  { label: "Charging Time", value: "3-4 Hrs", icon: BatteryChargingFullIcon },
...
const BuzzInfo = () => {
  ...
  return (
    ...
    >
        ...
        <Container >
          ...
          <Grid container spacing={6} alignItems="center">
            ...
            >
              ...
              >
                Built for Higher Performance & Maximum Load Efficiency. The BUZZ is engineered to handle demanding logistics needs while keeping operational costs at an absolute minimum.
              </Typography>
            </Grid>
      ...
      {/* ── Quick Specs ── */}
      <Box sx={{ bgcolor: shell.bandEven, borderTop: `1px solid ${shell.border}` }}>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <Typography
                      sx={{
                        color: isDark ? "rgba(255,255,255,0.65)" : "#5a6662",
                        fontSize: "0.875rem",
                        fontWeight: 500,
                        textTransform: "uppercase",
                        letterSpacing: 1,
      ...
      <Box sx={{ bgcolor: shell.bandOdd }}>
        <Container maxWidth="lg">
          ...
          <Grid container spacing={4} pb={{ xs: 8, md: 10 }}>
            {BUZZ_MODELS.map((model, index) => (
              <Grid
                item
                xs={12}
                md={4}
              ...
              >
                <Box
                  onClick={() => navigate(`/buzz-info/${model.id}`)}
                  sx={{
                    border: `1px solid ${shell.border}`,
                    borderRadius: 4,
                    overflow: "hidden",
                ...
                >
                  ...
                  <Box sx={{ p: 3 }}>
                    ...
                    <Typography
                      sx={{
                        color: isDark ? "rgba(255,255,255,0.68)" : "#5a6662",
                        fontSize: "0.98rem",
                        lineHeight: 1.65,
                        fontWeight: 400,
                      }}
